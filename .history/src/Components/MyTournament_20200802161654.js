    ...
    useEffect(() => {
        ...
        setMyTournament(Array(temp).fill(null).map((el, i) => {
            ...
            if (i === 0){
                ...
                console.log(intBattle);
                console.log("tempBattles: "+tempBattles[intBattle].name);
                tempBattles.splice(firstBattle,firstBattle + 1);
                console.log("tempBattles: "+tempBattles[inttBattle].name);
            }
