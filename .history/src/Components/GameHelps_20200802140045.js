...
export default function GameHelps({names, numGioc, tipo }) {
    ...
    useEffect(() => {
        ...
        const arrayNumGioc = [];
        const useEffectNames = names;
        const useEffectTipo = tipo;
        useEffectNames.forEach(() => {
            arrayNumGioc.push({
                riavvia: ((useEffectTipo === 'small') ? tipoSmall.riavvia :
                    ((useEffectTipo === 'medium') ? tipoMedium.riavvia : tipoBig.riavvia)),
                switch: ((useEffectTipo === 'small') ? tipoSmall.switch :
                    ((useEffectTipo === 'medium') ? tipoMedium.switch : tipoBig.switch))
            })
        });
