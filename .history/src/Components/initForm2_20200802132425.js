                            ...
                            {Array(numGioc).fill(null).map((pl, i) => {
                                return (
                                    <div key={"input-" + (i + 1)} className="mt-2">
                                        ...
                                        <select className="mt-2" name={"inputStatePlayer-" + (i + 1)} id={"inputStatePlayer-" + (i + 1)}
                                            ...
                                            {tracks.map(tr => {
                                                if (favoriteTracks.some((fvTr, fvInd) => (tr.id === fvTr && fvInd !== i))) return <React.Fragment key={"j-" + tr.id}></React.Fragment>;
