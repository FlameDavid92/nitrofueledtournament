...
export default function MyTournament({ tipo, numGioc, battles, tracks, players, setPlayers }) {
    ...
    return (
        <>
            <GameHelps names={players.map((pl) => pl.name)} numGioc={numGioc} tipo={tipo} switchTracks={switchTracks} setSwitchTracks={setSwitchTracks} myTournament={myTournament} setMyTournament={setMyTournament} currentGameId={currentGameId}></GameHelps>
