...
export default function GameHelps({ numGioc, tipo }) {
    ...
    useEffect(() => {
        ...
        const arrayNumGioc = [];
        Array(parseInt(numGioc)).fill(null).forEach(() => {
            arrayNumGioc.push({
                ...
                return (
                    <div className={"col-"+ ( (numGioc === "2") ? "6" : ( (numGioc==="3") ? "4":"3" ) )}>
                        <div key={'player-' + i} className="row">
                            <div className="col-12 h4">Giocatore {i + 1}</div>
                            <div className="col-3"><p>Riavvia: {pl.riavvia}</p></div>
                            <div className="col-9">
                                <div className="row">
                                    <div className="col-6">
                            ...
                            <div className="col-3"><p>Switch: {pl.switch}</p></div>
                            <div className="col-9">
                                <div className="row">
                                    <div className="col-6">
...
/*{numRiavvia}*/
/*onClick={superRiavvia}  disabled={(numRiavvia - 2) < 0}*/
/*onClick={decrementRiavvia} disabled={numRiavvia === 0}*/
/*{numSwitch}*/
/*onClick={transformSwitch} disabled={numSwitch === 0}*/
/*onClick={decrementSwitch} disabled={numSwitch === 0}*/