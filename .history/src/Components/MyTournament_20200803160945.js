...
export default function MyTournament({ tipo, numGioc, battles, tracks, players, setPlayers = { setPlayers } }) {
    ...
    return (
        <>
            <div className="row mt-2">
                ...
                <div className="col-6">
                    <PointsManager players={players} setPlayers={setPlayers} currentGameId={currentGameId} setCurrentGameId={setCurrentGameId}></PointsManager>
                </div>
            </div>
