...
function App() {
  ...
  return (
    <div className="container-fluid mt-2">
      ...
      {!initForm2 && (
        <>
          <GameHelps names={players.map((pl) => pl.name)} numGioc={numGioc} tipo={tipo} switchTracks={switchTracks} myTournament={myTournament} setMyTournament={setMyTournament}></GameHelps>
          <MyTournament myTournament={myTournament} setMyTournament={setMyTournament} tipo={tipo} numGioc={numGioc} battles={nitroFueled.battles} tracks={nitroFueled.tracks} setPlayers={setPlayers} players={players} setSwitchTracks={setSwitchTracks}></MyTournament>
        </>
      )}
